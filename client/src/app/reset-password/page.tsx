  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#476869] px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 space-y-6">
        ...
        className="w-full p-3 border-2 border-[#00A79D] rounded-xl bg-white text-black placeholder-gray-600 placeholder-opacity-100 focus:outline-none focus:ring-2 focus:ring-[#00A79D]"
      />
